 ...
 * 
 * For map field
 * Seperate field saving will be usefull if you use latitude and longitude in queries
 * 
 **/
if(!empty($_POST['mui_location_fields'])){
  foreach($_POST['mui_location_fields'] as $map_field){
    update_post_meta($post_id,$map_field.'_full_address',$_POST[$map_field][0]);
    update_post_meta($post_id,$map_field.'_lat',$_POST[$map_field][1]);
    update_post_meta($post_id,$map_field.'_long',$_POST[$map_field][2]);
    update_post_meta($post_id,$map_field.'_state',$_POST[$map_field][6]);
    update_post_meta($post_id,$map_field.'_zipcode',$_POST[$map_field][7]);
    update_post_meta($post_id,$map_field.'_country',$_POST[$map_field][8]);
  }
}
